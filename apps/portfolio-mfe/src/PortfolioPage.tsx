...
export default function PortfolioPage() {
  ...
  const trading = (
    theme.palette as unknown as {
      trading?: { uptick: string; downtick: string };
    }
  ).trading;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Tooltip
          title="Total gain or loss if all open positions were closed at current market prices"
          placement="right"
        >
          <Typography
            variant="overline"
        ...
        >
          <Box>
            <Tooltip
              title="Number of currently open trading positions"
              placement="top"
            >
              <Typography
                variant="caption"
            ...
            <Typography
              variant="body1"
              fontWeight={600}
              aria-label={`Open positions: ${summary.positionCount}`}
            >
          ...
          <Box>
            <Tooltip
              title="Total current market value of all open positions"
              placement="top"
            >
              <Typography
                variant="caption"
            ...
            <TableHead>
              <TableRow>
                ...
                <SortableHeader
                  label="Avg Cost"
                  sortKey="averageCost"
                  tooltip="Average price paid per share across all purchases"
                ...
                <SortableHeader
                  label="Market Price"
                  sortKey="marketPrice"
                  tooltip="Current live market price for this symbol"
                  sx={{ display: { xs: "none", md: "table-cell" } }}
                  sort={sort}
                  onSort={handleSort}
                />
                ...
                >
                  <Tooltip
                    title="Current total value of this position (shares × market price)"
                    placement="top"
                  >
                    <span>Mkt Value</span>
                  </Tooltip>
                ...
                <SortableHeader
                  label="% Return"
                  sortKey="pctReturn"
                  tooltip="Percentage gain or loss relative to your average cost"
                  sort={sort}
                  onSort={handleSort}
                />
                <TableCell
                ...
                >
                  <Tooltip
                    title="Price movement sparkline for the last 5 minutes"
                    placement="top"
                  >
                    <span>Trend</span>
                  </Tooltip>
